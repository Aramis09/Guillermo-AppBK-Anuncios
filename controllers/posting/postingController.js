...
const createPost = async (req, res) => {
  ...
  bulkObjToCreate = categoriesFoundIds.map((categoryId) => ({
    postId: newPost.id,
    categoryId,
  }));
...
const editPost = async (req, res) => {
  ...
  const { title, description, img, number_phone, personal_page, location } =
    req.body;
  ...
  postFound.personal_page = personal_page
    ? personal_page
    : postFound.personal_page;
